...
import { FileText, Plus, Edit, Trash2, Zap } from 'lucide-react';
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs border-collapse">
            ...
            <tbody className="divide-y divide-gray-800/60">
              {articles.map((art) => (
                <tr key={art.id} className="hover:bg-gray-800/40">
                  ...
                  <td className="p-3 text-right space-x-2">
                    <button className="p-1.5 bg-gray-800 hover:bg-gray-700 rounded text-gray-300">
